...
void ipc::communication::read_callback_init(os::error ec, size_t size) {
...
void ipc::communication::read_callback_msg(os::error ec, size_t size) {
	/// Processing
...
void ipc::communication::write_callback(os::error ec, size_t size) {
	m_wop->invalidate();
	m_rop->invalidate();
}
